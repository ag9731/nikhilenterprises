  ...
  const array = [
    {
      ...
      url: "/PVCBlinds/pvcblinds_1.webp",
    },
    {
      id: 2,
      title: "Air curtain",
      ...
      <div className="pvcstripcurtain">
        <div className="pvcContent">
          ...
          <div className="pvcContentpara">
            <p>
              PVC blinds are versatile and durable window coverings made from
              polyvinyl chloride material. They offer excellent light control
              and privacy, making them ideal for both residential and commercial
              spaces. Easy to clean and maintain, PVC blinds are resistant to
              moisture and humidity, making them perfect for kitchens,
              bathrooms, and outdoor areas. Available in various styles and
              colors, they enhance the aesthetic appeal of any room while
